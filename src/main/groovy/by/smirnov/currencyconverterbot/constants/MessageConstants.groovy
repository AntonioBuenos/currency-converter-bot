...
interface MessageConstants {
    ...
    String MESSAGE_SPAM = "Введите текст, который хотите отправить всем пользователям"
    String DAILY_RATE_TYPE_MESSAGE = "Выберите курсы основных валют или курсы всех валют, устанавливаемых НБРБ на %s:"
    String MESSAGE_STUB_REPLY = "Ой, даже не знаю, что Вам на это ответить, %s! \
            Попробуйте использовать команды, я люблю подчиняться четким указаниям!"
    String MESSAGE_NEW_RATES = "А у меня для Вас новые официальные курсы валют НБ на"
}